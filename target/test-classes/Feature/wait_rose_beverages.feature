...
Feature: Validate Beverages section of Wait_Rose
 ...
 #   Then user validates the login dashboard Page title "<Title>"

    Examples: 
      | username                | password | err                       | file       | Title |
      #|                         | Raj@1993 | Not_entering_email       | login_page |       |
      #| rsjayabalan06@gmail.com |          | Not_enetering_Password   | login_page |       |
      ...
      #| rsjayabalan06           | Raj@1993 | Enter_valid_email        | login_page |       |
       | rsjayabalan18@gmail.com | Raj@1993 | valid_email_and_password | login_page |       |
